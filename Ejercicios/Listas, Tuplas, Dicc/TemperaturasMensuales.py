...
MinProAnual = min(DiccPromedioAnual.values()) # Almacenamos el valorr minimo del promedio anual
...
#OPCION2:
print(f'\n La ciudad con el promedio anual mas ALTO es {max(DiccPromedioAnual, key=DiccPromedioAnual.get)} con un promedio de: {MaxProAnual} ºC')
...
#OPCION2:
print(f'\n La ciudad con el promedio anual mas BAJO es {min(DiccPromedioAnual, key=DiccPromedioAnual.get)} con un promedio de: {MinProAnual} ºC')
...
for i in ListaPromedioAnual1:
    print(f'La lista de las ciudades ordenadas es: {i}, {DiccPromedioAnual[i]}')
